...
function initLicenseSelection(config) {
    ...
    // Use TRIKUSEC_URL for downloads (enroll.sh), TRIKUSEC_LYNIS_API_URL for API (upload-server)
    // Fallback to trikusecUrl if trikusecLynisApiUrl not provided (backward compatibility)
    const apiUrl = trikusecLynisApiUrl || trikusecUrl;
