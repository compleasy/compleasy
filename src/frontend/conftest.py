...
"""
import pytest
from api.models import PolicyRule, PolicyRuleset, Device, Organization, LicenseKey
...
@pytest.fixture
def test_license_data(db, test_user):
    """
    Create sample license data for testing.
    
    Returns a dict with:
    - default_license: A default LicenseKey object (id=1 or lowest id)
    - autogenerated_licenses: List of existing autogenerated licenses (if any)
    
    Note: The default_license must be created FIRST so it gets id=1 (or lowest id).
    """
    # Create default organization if needed
    default_org, _ = Organization.objects.get_or_create(
        slug='default',
    ...
    # Create the default license FIRST so it gets id=1 (or lowest id)
    # This is the license that will be shown as "default" in the UI
    default_license = LicenseKey.objects.create(
        name='Default Test License',
    ...
    # Create a few autogenerated licenses to test incremental naming
    # These are created AFTER the default license
    autogenerated_licenses = []
    for i in range(3):
        license = LicenseKey.objects.create(
            name=f'Autogenerated license-key {i+1}',
            licensekey=generate_license_key(),
            max_devices=1,
            is_active=True,
            created_by=test_user,
        ...
        autogenerated_licenses.append(license)
    
    return {
        'default_license': default_license,
        'autogenerated_licenses': autogenerated_licenses
    }
